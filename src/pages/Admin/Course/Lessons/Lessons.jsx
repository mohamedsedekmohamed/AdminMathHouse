...
const Lessons = () => {
  ...
  const { patchData, loading: loadingPatch } = usePatch("/api/admin/lessons/swap-order");
...
<button
 ...
 className="
    px-6 py-3 rounded-xl text-one font-semibold
      ...
      <ReusableTable
        ...
        extraActions={(row) => (
          <>
            ...
            {/* Go to Ideas */}
            {/* <NavChild route={`/admin/courses/ideas/${row.id}`} /> */}
          </>
        )}
        onEdit={handleEdit}
